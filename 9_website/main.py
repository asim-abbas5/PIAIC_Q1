...
# Define pages
def home():
    st.markdown('<h1> Hello My Name is <span style="color: aqua;"> Asim Abbas </span> </h1>', unsafe_allow_html=True)
    
    st.image("me.jpg", width=200)
    st.markdown("""
        <div class="links">
            <a href="https://github.com/asim-abbas5" target="_blank">Github</a><br>
